...
* @route '/livewire-fb309d79/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-fb309d79/livewire.js',
...
* @route '/livewire-fb309d79/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-fb309d79/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-fb309d79/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-fb309d79/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
