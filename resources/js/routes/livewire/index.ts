...
* @route '/livewire-fb309d79/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-fb309d79/upload-file',
...
* @route '/livewire-fb309d79/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-fb309d79/preview-file/{filename}',
